					...
					<div class="item">
						...
						<div class="col-sm-6">
							<img src="<c:url value='/template/web/images/home/girl2.jpg' />"
								class="girl img-responsive" alt="" /> <img
								src="<c:url value='/template/web/images/home/pricing.
								ng' />"
								alt="" />
						</div>
					</div>
					...
					<div class="product-image-wrapper">
						<div class="single-products">
							<div class="productinfo text-center">
								<img
									src="<c:url value='/template/web/images/home/product1.jpg' />"
									alt="" />
								<h2>$56</h2>
				...
				<div class="col-sm-4">
					<div class="product-image-wrapper">
						<div class="single-products">
							<div class="productinfo text-center">
								<img
									src="<c:url value='/template/web/images/home/product2.jpg' />"
									alt="" />
								<h2>$56</h2>
								<p>Easy Polo Black Edition</p>
								<a href="#" class="btn btn-default add-to-cart"><i
				...
				<div class="col-sm-4">
					<div class="product-image-wrapper">
						<div class="single-products">
							<div class="productinfo text-center">
								<img
									src="<c:url value='/template/web/images/home/product3.jpg' />"
									alt="" />
								<h2>$56</h2>
								<p>Easy Polo Black Edition</p>
								<a href="#" class="btn btn-default add-to-cart"><i
				...
				<div class="col-sm-4">
					<div class="product-image-wrapper">
						<div class="single-products">
							<div class="productinfo text-center">
								<img
									src="<c:url value='/template/web/images/home/product4.jpg' />"
									alt="" />
								<h2>$56</h2>
								<p>Easy Polo Black Edition</p>
								<a href="#" class="btn btn-default add-to-cart"><i
							...
							<img src="<c:url value='/template/web/images/home/new.png' />"
								class="new" alt="" />
						</div>
						<div class="choose">
							<ul class="nav nav-pills nav-justified">
				...
				<div class="col-sm-4">
					<div class="product-image-wrapper">
						<div class="single-products">
							<div class="productinfo text-center">
								<img
									src="<c:url value='/template/web/images/home/product5.jpg' />"
									alt="" />
								<h2>$56</h2>
								<p>Easy Polo Black Edition</p>
								<a href="#" class="btn btn-default add-to-cart"><i
							...
							<img src="<c:url value='/template/web/images/home/sale.png' />"
								class="new" alt="" />
						</div>
						<div class="choose">
							<ul class="nav nav-pills nav-justified">
				...
				<div class="col-sm-4">
					<div class="product-image-wrapper">
						<div class="single-products">
							<div class="productinfo text-center">
								<img
									src="<c:url value='/template/web/images/home/product6.jpg' />"
									alt="" />
								<h2>$56</h2>
								<p>Easy Polo Black Edition</p>
								<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-4">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<c:url value='/template/web/images/home/recommend1.jpg' />"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-4">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<c:url value='/template/web/images/home/recommend2.jpg' />"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
							...
							<div class="col-sm-4">
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<img
												src="<c:url value='/template/web/images/home/recommend3.jpg' />"
												alt="" />
											<h2>$56</h2>
											<p>Easy Polo Black Edition</p>
											<a href="#" class="btn btn-default add-to-cart"><i
