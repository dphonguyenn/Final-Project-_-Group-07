					...
					<div class="form-two">
						<form>
							<input type="text" placeholder="Zip / Postal Code *"> <select>
								...
								<option>Canada</option>
								<option>Dubai</option>
							</select> <input type="password" placeholder="Confirm password"> <input
								type="text" placeholder="Phone *"> <input type="text"
								placeholder="Mobile Phone"> <input type="text"
								placeholder="Fax">
						</form>
					</div>
				</div>
			...
			<tbody>
				<tr>
					<td class="cart_product"><a href=""><img
							src="<c:url value='/template/web/images/cart/one.png' />" alt=""></a></td>
				...
				<tr>
					<td class="cart_product"><a href=""><img
							src="<c:url value='/template/web/images/cart/two.png' />" alt=""></a></td>
					<td class="cart_description">
						<h4>
							<a href="">Colorblock Scuba</a>
						</h4>
				...
				<tr>
					<td class="cart_product"><a href=""><img
							src="<c:url value='/template/web/images/cart/three.png' />" alt=""></a></td>
					<td class="cart_description">
						<h4>
							<a href="">Colorblock Scuba</a>
						</h4>
